...
import com.pg.paymentgateway.service.RBLSmartFileProcessor;
...
@RestController
@Slf4j
public class RBLSmartBankController {
    @Autowired
    RBLSmartFileProcessor fileProcessor;

    private static final Logger logger = LoggerFactory.getLogger(RBLSmartBankController.class);

    @PostMapping("/rblsmart")
