...
@RestController
@Slf4j
public class IdfcBankController {
    @Autowired
    public IDFCFileProcessor fileProcessor;

    private static final Logger logger = LoggerFactory.getLogger(IdfcBankController.class);
