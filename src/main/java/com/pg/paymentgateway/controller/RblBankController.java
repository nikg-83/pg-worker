...
import com.pg.paymentgateway.service.RBLFileProcessor;
...
@RestController
@Slf4j
public class RblBankController {
    @Autowired
    public RBLFileProcessor fileProcessor;

    private static final Logger logger = LoggerFactory.getLogger(RblBankController.class);
