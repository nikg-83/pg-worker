...
import com.pg.paymentgateway.service.IDFCFileProcessor;
import com.pg.paymentgateway.service.IndusFileProcessor;
...
@RestController
@Slf4j
public class IndusBankController {
    @Autowired
    public IndusFileProcessor fileProcessor;

    private static final Logger logger = LoggerFactory.getLogger(IndusBankController.class);
    ...
    public ResponseEntity<Void> onSqsMessage(
        ...
        fileProcessor.processMessage(sqsdMessageBody);
